...
#updateModal input#purpose,
#updateModal textarea#notes{
    padding:10px 10px;   /* ← dagdag space sa loob */
    font-size:14px;
    border-radius:12px;
}

/* dagdag breathing space sa taas at baba ng box */
#updateModal textarea#notes{
    min-height:95px;
    line-height:1.4;
}
...
<tr>
<th>Queue</th><th>Name</th><th>Service</th><th>Date</th><th>Time</th><th>Status</th><th>Staff Assigned</th><th>Purpose/Reason</th><th>Additional Notes</th>
<th>Action</th>
</tr>
</thead>
<tbody>
...
<div class="mb-3">
    <label>Purpose</label>
    <input type="text" name="purpose" id="purpose" class="form-control rounded-3">
</div>

<div class="mb-3">
    <label>Additional Notes</label>
    <textarea name="notes" id="notes" class="form-control rounded-3"></textarea>
</div>
...
timeSlots.forEach(slot=>{
    ...
    document.getElementById('purpose').value = button.getAttribute('data-purpose');
